<?php
$PageTitle = "Braeger Advantage";
$PageBanner = "banner-sub-finance.jpg";
include "header.php";
?>

<h2>WHY PARTICIPATE WITH US?</h2>

<div class="right" style="width: 300px; font-size: 80%; line-height: 1.1em; text-align: center;">
  <img src="images/braeger-advantage.jpg" alt="Our agile business model will get you to the finish line."><br>
  Our agile business model will get you to the finish line.
</div>

The economy is improving and more people are purchasing automobiles. We do significant due diligence on our dealer's finance companies to ensure they have a strong balance sheet, significantly low default rates, and a strong valuation on their current portfolio.<br>
<br>

Private debt offers an attractive risk adjusted return (alpha) in tough times.  The private auto debt market has a long history of delivering a higher rate of return than other alternatives.  The alpha from the private auto finance market comes from a combination of three identifiable and measureable sources: higher interest rates, low loan default rates and an active relationship based on investment management.<br>
<br>

The key to success in the private auto finance market is active-relationship-based investment management with the dealers.   Braeger Finance's auto finance market managers maintain direct contact with borrowers from the inception of the investment until it is fully repaid.  This significantly reduces risk due to greater control over the structuring, management, and administration of the investments.<br>
<br>
